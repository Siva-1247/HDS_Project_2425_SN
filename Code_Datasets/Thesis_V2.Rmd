...
- The most significant limitation is that vaccination data were available only at the LEA level, and that it was not broken down by demographic subgroups or to the small area level. This is only helpful for identifying general geographic trends and without granular analysis within each LEA, we are limited to ecological inference, which carries risks of ecological fallacy—i.e., making assumptions about individuals based on population level data.

- The demographics of the population were taken from the 2022 Census, which does not precisely correspond with the vaccination rollout period. Events like student mobility, deaths, emigration, or temporary relocations are unaccounted for and this temporal misalignment is particularly troublesome in regions that experience seasonal fluctuations or considerable population turnover.

- Self-reported health status is used as a covariate and the subjective nature of these data makes them vulnerable to reporting bias, especially when comparing various age groups, gender or educational attainment. It is challenging to effectively evaluate the predictive/ associative ability of these self-assessments and validate them in the absence of clinical or administrative health information.
...
- Cross-border vaccination was not taken into consideration in LEAs that are contiguous to Northern Ireland, and our analysis was limited to the Republic of Ireland. This absence might mask the ground truth in the border regions, especially if people traveled to Northern Ireland to get vaccinated or vice versa, which could affect local vaccination uptake rates. This is a significant omission that has consequences for international comparability and public health planning due to the interconnection of the border towns.
