...
Despite this pronounced variation in area-level deprivation, the composite deprivation index showed a negligible association with vaccination rates, with the CI including zero, suggesting that area-level socioeconomic deprivation does not provide additional explanatory power beyond the specific educational attainment variables already included in the model.This finding is particularly noteworthy given the substantial socioeconomic disparities observed across LEAs, indicating that educational composition might effectively capture the most relevant aspects of socioeconomic variation affecting vaccination behavior. 

The results suggest that deprivation effects operate primarily through already-measured demographic and educational pathways rather than through additional unmeasured mechanisms. The lack of significant association indicates that while the Pobal index comprehensively measures community-level disadvantage across a wide range of conditions, individual educational characteristics remain the dominant socioeconomic predictor of vaccination uptake, effectively mediating the influence of broader area-level deprivation measures.
...
We observed substantial variation in vaccination outcomes across LEAs, with a random effect standard deviation of 0.81 (95% CI: 0.73–0.91) for the asymptote parameter, indicating notable differences in maximum vaccination rates between areas. The base asymptote showed more modest variation with a standard deviation of 0.25 (95% CI: 0.22-0.29), while the timing of peak uptake demonstrated relatively low variation between LEAs and the inflection point random effect standard deviation was only 0.26 (95% CI: 0.23-0.30), suggesting moderately synchronized temporal patterns across LEAs despite substantial differences in final vaccination levels.

The demographic predictors revealed significant positive associations between all covariates and final vaccination rate achievement. We found that individuals aged 65–70 exhibited the strongest positive effect among all age groups, surpassing even those aged 71 and older. 
...
The adjusted base model demonstrated superior fit, as evidenced by the increased precision parameter (phi = 77.74 vs. 57.18), indicating reduced unexplained variance. 
...
The stability of key demographic and educational effects across all model specifications provides strong evidence for their robustness, while the significant spatial correlation highlights the importance of geographic context in understanding vaccination behaviour patterns.
...
The longitudinal nonlinear model revealed nuanced demographic dynamics in vaccination uptake that differ from patterns observed in cross-sectional analyses.

The Asym was significantly and positively associated with the relative proportions of males and all working-age and older adult subgroups (ages 18–54, 55–64, and 65–70), with the strongest effects observed for the older cohorts. These findings suggest that, although younger adults and males may have exhibited delayed uptake in earlier phases of the campaign—as suggested in prior models—they ultimately reached high levels of vaccination over time. 
...
The scalar parameter governing growth rate (scal = 1.36) was fixed across areas and reinforces the interpretation that differences in eventual uptake—rather than uptake speed—were more influenced by population structure than by supply-side constraints. Together, these results indicate that extended temporal observation is critical for capturing the full extent of vaccination behaviour: initial disparities in uptake timing do not necessarily translate into persistent inequalities in ultimate coverage. 
...
- The most significant limitation is that vaccination data were available only at the Local Electoral Area (LEA) level, not broken down by demographic subgroups or small area level. This is only helpful for identifying general geographic trends and without granular analysis within each LEA, we are limited to ecological inference, which carries risks of ecological fallacy—i.e., making assumptions about individuals based on group-level data.

- The demographics of the population were taken from the 2022 Census, which does not precisely correspond with the 2020–2022 vaccination rollout schedule. It is possible that denominator estimates for vaccination rates may be biased due to inaccurately recorded changes in population structure during the pandemic, such as student mobility, deaths, emigration, or temporary relocations. This temporal misalignment is particularly troublesome in regions that experience seasonal fluctuations or considerable population turnover.

- Self-reported health status is used as a covariate and the subjective nature of these data makes them vulnerable to reporting bias, especially when comparing various age groups, gender or educational attainment. It is challenging to effectively evaluate the predictive ability of these self-assessments and validate them in the absence of clinical or administrative health information.

- Our accessibility measure did not account for population demand or healthcare services' capacity, limiting its interpretive power; while a 2SFCA approach or another gravity based approach could address these spatial limitations, it requires more granular data and computational resources beyond this study's scope. 

- Cross-border vaccination was not taken into consideration in LEAs that are contiguous to Northern Ireland, and our analysis was limited to the Republic of Ireland. This absence might skew data in border regions, especially if people traveled to Northern Ireland to get vaccinated (or vice versa), which could affect local vaccination uptake rates. This is a significant omission that has consequences for international comparability and public health planning due to the interconnection of border towns.

- The ecological design does not allow us to make causal inferences. Although we find significant correlations between vaccination uptake and the covariates considered in our study, we cannot link these patterns to individual-level behavior. Furthermore, unmeasured variables like vaccine hesitancy at the individual level, internet literacy, or government trust may potentially be significant.
